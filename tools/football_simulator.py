...
from football2.football.play_resolution import PlayResolutionEngine, ResolutionConfig, PlayOutcome
from football2.football.play_analyzer import PlayAnalyzer, TacticalAdvantage
...
class FootballSimulator:
    ...
    def load_team_config(self, config_path: str) -> TeamConfig:
        ...
        return TeamConfig(
            ...
            expected_performance=config.get('expected_vs_defenses', {}) if config['play_type'] == 'run' else config.get('expected_vs_plays', {})
        )
    ...
    def _analyze_tactical_matchup(self, offense: TeamConfig, defense: TeamConfig) -> Dict[str, Any]:
        ...
        if offense.play_type == 'run':
            ...
            blocking_advantage = (avg_blocking - avg_run_defense) // 5  # Every 5 points = +/- 1
    ...
    def run_simulation(
        ...
        # Explosive play rate
        explosive_threshold = offense.success_metrics.get('explosive_gain_threshold', 15)
...
def main():
    ...
    scenarios = [
        {
            'name': 'Elite vs Elite',
            'offense': '/Users/jasonmcinerney/repos/football/data/configs/elite_offense_trap.yaml',
            'defense': '/Users/jasonmcinerney/repos/football/data/configs/elite_defense_cover3.yaml'
        },
        {
            'name': 'Elite vs Average',
            'offense': '/Users/jasonmcinerney/repos/football/data/configs/elite_offense_trap.yaml',
            'defense': '/Users/jasonmcinerney/repos/football/data/configs/average_defense_cover3.yaml'
        },
        {
            'name': 'Average vs Elite',
            'offense': '/Users/jasonmcinerney/repos/football/data/configs/average_offense_trap.yaml',
            'defense': '/Users/jasonmcinerney/repos/football/data/configs/elite_defense_cover3.yaml'
        },
        {
    ...
    for scenario in scenarios:
        try:
            ...
            print_simulation_results(scenario['name'], f"{offense.label} vs {defense.label}", analysis)
