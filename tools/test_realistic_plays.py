...
def load_play_yaml(team: str, play_name: str):
    ...
    play_file = f"/Users/jasonmcinerney/repos/football/data/plays/{team}/{play_name}.yaml"
...
def test_realistic_plays():
    ...
    for scenario in test_scenarios:
        ...
        print(f"   Situation: {scenario['situation']['down']} & {scenario['situation']['distance']}")
        ...
        try:
            ...
            if results:
                ...
                # Realism check
                if avg_yards > 10:
                    print(f"   ⚠️  HIGH AVERAGE: {avg_yards:.1f} yards may be unrealistic")
                elif avg_yards > 6:
                    print(f"   ✅ GOOD AVERAGE: {avg_yards:.1f} yards is realistic for quality run")
                else:
                ...
                if max_yards > 25:
                    ...
                    print(f"   ✅ MAX REALISTIC: {max_yards} yard maximum is reasonable")
