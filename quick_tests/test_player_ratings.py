...
def create_player_archetypes():
    ...
    players["elite_qb"] = PlayerProfile(
        ...
        position="QB",
        overall_rating=95,
        skills={SkillCategory.AWARENESS: 99, SkillCategory.HANDS: 90},
    )
    ...
    players["avg_qb"] = PlayerProfile(
        ...
        position="QB",
        overall_rating=75,
        skills={SkillCategory.AWARENESS: 75, SkillCategory.HANDS: 75},
    )
    ...
    players["elite_cb"] = PlayerProfile(
        ...
        position="CB",
        overall_rating=93,
        skills={SkillCategory.COVERAGE: 95, SkillCategory.TACKLE: 88},
    )
    ...
    players["avg_cb"] = PlayerProfile(
        ...
        position="CB",
        overall_rating=75,
        skills={SkillCategory.COVERAGE: 75, SkillCategory.TACKLE: 73},
    )
    ...
    players["poor_cb"] = PlayerProfile(
        ...
        position="CB",
        overall_rating=65,
        skills={SkillCategory.COVERAGE: 62, SkillCategory.TACKLE: 68},
    )
    ...
    players["elite_lb"] = PlayerProfile(
        ...
        position="LB",
        overall_rating=90,
        skills={SkillCategory.TACKLE: 93, SkillCategory.COVERAGE: 85},
    )
    ...
    players["avg_lb"] = PlayerProfile(
        ...
        position="LB",
        overall_rating=75,
        skills={SkillCategory.TACKLE: 76, SkillCategory.COVERAGE: 70},
    )
...
def test_player_impact():
    ...
    for scenario in scenarios[:3]:  # Pass scenarios
        ...
        for qb_key, wr_key, cb_key, description in pass_combos:
            ...
            print(f"   {description}")
            print(
                f"      📊 Completion: {completion_rate:.0f}% | Avg: {avg_yards:.1f} yds | YAC: {avg_yac:.1f} | Missed tackles: {avg_missed:.1f}"
            )
    ...
    for scenario in scenarios[3:]:  # Run scenarios
        ...
        for rb_key, def_keys, description in run_combos:
            ...
            print(f"   {description}")
            print(
                f"      📊 Avg: {avg_yards:.1f} yds | YAC: {avg_yac:.1f} | Missed tackles: {avg_missed:.1f} | Fumbles: {fumble_rate:.0f}%"
            )
...
def test_situational_impact():
    ...
    for situation, desc in situations:
        ...
        print(
            f"   {desc}: {completion_rate:.0f}% completion | {avg_yards:.1f} avg yards"
        )
