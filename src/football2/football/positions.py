...
class WideReceiver(FootballPosition):
    def __init__(self):
        super().__init__("WR", {
            ...
            (Lane.MIDDLE, FootballDepth.LINE.value),  # Rare but possible (trips formation)
...
class FootballFormation(Formation):
    ...
    def __init__(self, name: str, roles: Dict[str, PlayerRole], personnel: List[str] | None = None):
