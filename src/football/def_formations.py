...
def def_34() -> DefFormation:
    f = DefFormation()
    f.add("left","line",1).add("middle","line",1).add("right","line",1)
    f.add("left","box",1).add("middle","box",2).add("right","box",1)
    f.add("left","deep",2).add("right","deep",2)
    return f

def goalline() -> DefFormation:
    f = DefFormation()
    f.add("left","line",2).add("middle","line",2).add("right","line",2)
    f.add("left","box",1).add("middle","box",1).add("right","box",1)
    f.add("left","deep",1).add("right","deep",1)
